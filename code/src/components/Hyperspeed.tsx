...
class App {
  ...
  scene: THREE.Scene;
  renderPass!: InstanceType<typeof RenderPass>;
  bloomPass!: InstanceType<typeof EffectPass>;
  clock: THREE.Clock;
  ...
  constructor(container: HTMLElement, options: HyperspeedOptions) {
    ...
    // ensure the canvas element's CSS size matches the container to avoid overflow
